...
LEFT JOIN omop.CONDITION_OCCURRENCE AS e
...
SELECT
  t.*
FROM omop.CONDITION_OCCURRENCE AS t
...
WHERE
  t.CONDITION_END_DATE < p.birth_datetime;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_END_DATETIME < p.birth_datetime;
...
FROM omop.CONDITION_OCCURRENCE
WHERE
  CONDITION_OCCURRENCE_ID IS NULL;
...
FROM omop.CONDITION_OCCURRENCE
WHERE
  NOT CONDITION_OCCURRENCE_ID IS NULL
GROUP BY
  CONDITION_OCCURRENCE_ID
HAVING
  COUNT(*) > 1;
...
FROM omop.CONDITION_OCCURRENCE AS c
LEFT JOIN omop.CONCEPT AS p
  ON c.CONDITION_SOURCE_CONCEPT_ID = p.CONCEPT_ID
WHERE
  NOT c.CONDITION_SOURCE_CONCEPT_ID IS NULL AND p.CONCEPT_ID IS NULL;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_START_DATE < p.birth_datetime;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_START_DATETIME < p.birth_datetime;
...
FROM omop.CONDITION_OCCURRENCE AS c
LEFT JOIN omop.CONCEPT AS p
  ON c.CONDITION_STATUS_CONCEPT_ID = p.CONCEPT_ID
WHERE
  NOT c.CONDITION_STATUS_CONCEPT_ID IS NULL AND p.CONCEPT_ID IS NULL;
...
LEFT JOIN omop.concept AS c
  ON t.CONDITION_STATUS_CONCEPT_ID = c.concept_id
WHERE
  NOT t.CONDITION_STATUS_CONCEPT_ID IS NULL
...
FROM omop.CONDITION_OCCURRENCE
WHERE
  CONDITION_TYPE_CONCEPT_ID IS NULL;
...
FROM omop.CONDITION_OCCURRENCE AS c
LEFT JOIN omop.CONCEPT AS p
  ON c.CONDITION_TYPE_CONCEPT_ID = p.CONCEPT_ID
WHERE
  NOT c.CONDITION_TYPE_CONCEPT_ID IS NULL AND p.CONCEPT_ID IS NULL;
...
LEFT JOIN omop.concept AS c
  ON t.CONDITION_TYPE_CONCEPT_ID = c.concept_id
WHERE
  NOT t.CONDITION_TYPE_CONCEPT_ID IS NULL
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 26662 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 26935 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 30969 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 73801 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 74322 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 78193 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 79758 AND p.gender_concept_id <> 8507;
...
SELECT
  ...
  80180 AS concept_id
FROM concept_cnt AS c
CROSS JOIN total_cnt AS t
WHERE
  (
    c.n::REAL / NULLIF(t.n, 0)
  ) < 0.0584;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 141917 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 192367 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 192676 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 192683 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 192854 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 192858 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 193254 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 193261 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 193262 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 193277 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 193437 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 193439 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 193522 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 193530 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 193739 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 193818 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 194092 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 194286 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 194412 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 194420 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 194611 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 194696 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 194871 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 194997 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 195009 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 195012 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 195197 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 195316 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 195321 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 195483 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 195500 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 195501 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 195683 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 195769 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 195770 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 195793 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 195867 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 195873 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 196048 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 196051 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 196068 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 196157 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 196158 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 196163 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 196165 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 196168 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 196359 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 196364 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 196473 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 196734 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 196738 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 196758 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 197032 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 197039 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 197044 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 197236 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 197237 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 197507 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 197601 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 197605 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 197606 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 197607 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 197609 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 197610 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 197938 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 198082 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 198108 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 198194 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 198197 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 198198 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 198202 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 198212 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 198363 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 198471 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 198483 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 198803 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 198806 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 199067 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 199078 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 199752 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 199764 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 199876 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 199877 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 199878 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 199881 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 200051 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 200052 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 200147 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 200445 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 200452 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 200461 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 200670 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 200675 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 200775 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 200779 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 200780 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 200962 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 200970 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 201072 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 201078 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 201211 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 201238 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 201244 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 201257 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 201346 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 201355 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 201527 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 201617 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 201625 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 201801 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 201817 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 201823 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 201907 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 201909 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 201913 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 314409 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 315586 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 433716 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 434251 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 435315 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 435648 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 436155 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 436358 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 436366 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 436466 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 437501 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 437655 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 438477 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 439871 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 440971 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 441068 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 441077 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 441805 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 442781 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 443211 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 443435 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 443800 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 444078 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 444106 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4005743 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4005933 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4012343 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4016155 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4032594 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4048225 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4050091 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4051956 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4054550 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4056903 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4060207 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4060556 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4060558 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4060559 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4061050 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4071874 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4081648 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4090039 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4092515 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4093346 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4095940 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4109081 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4128329 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4129155 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4140828 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4143116 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4147021 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4149084 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4150042 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4150816 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4155529 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4156113 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4162860 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4163261 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4171394 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4171915 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4180978 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4194652 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4199600 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4235215 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4260520 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4270932 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4279913 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4281030 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4294393 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4295261 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4303258 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4320332 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 4339088 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 40481080 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 40482030 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 40482406 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 40483613 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 40490888 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 42709954 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 45757415 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 45766654 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 45770892 AND p.gender_concept_id <> 8532;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID = 45772671 AND p.gender_concept_id <> 8507;
...
JOIN omop.person AS p
  ON t.person_id = p.person_id
WHERE
  t.CONDITION_CONCEPT_ID IN (
      SELECT
        descendant_concept_id
      FROM omop.concept_ancestor
      WHERE
        ancestor_concept_id = 4090861
  )
