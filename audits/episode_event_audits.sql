...
LEFT JOIN omop.CONCEPT p ON c.EPISODE_EVENT_FIELD_CONCEPT_ID = p.CONCEPT_ID
...
JOIN omop.concept c ON t.EPISODE_EVENT_FIELD_CONCEPT_ID = c.concept_id
...
-- Description: Check that concepts in 'EPISODE_EVENT.EPISODE_EVENT_FIELD_CONCEPT_ID' are standard and valid.
        ...
        SELECT t.*
FROM omop.EPISODE_EVENT t
LEFT JOIN omop.concept c ON t.EPISODE_EVENT_FIELD_CONCEPT_ID = c.concept_id
