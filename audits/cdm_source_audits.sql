...
LEFT JOIN omop.CONCEPT p ON c.CDM_VERSION_CONCEPT_ID = p.CONCEPT_ID
...
JOIN omop.concept c ON t.CDM_VERSION_CONCEPT_ID = c.concept_id
...
-- Description: Check that concepts in 'CDM_SOURCE.CDM_VERSION_CONCEPT_ID' are standard and valid.
        ...
        SELECT t.*
FROM omop.CDM_SOURCE t
LEFT JOIN omop.concept c ON t.CDM_VERSION_CONCEPT_ID = c.concept_id
