...
LEFT JOIN omop.CONCEPT p ON c.COUNTRY_CONCEPT_ID = p.CONCEPT_ID
...
JOIN omop.concept c ON t.COUNTRY_CONCEPT_ID = c.concept_id
...
-- Description: Check that concepts in 'LOCATION.COUNTRY_CONCEPT_ID' are standard and valid.
        ...
        SELECT t.*
FROM omop.LOCATION t
LEFT JOIN omop.concept c ON t.COUNTRY_CONCEPT_ID = c.concept_id
