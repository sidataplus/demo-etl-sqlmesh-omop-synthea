MODEL (
  ...
  column_descriptions (
    dose_era_id = 'A unique identifier for each Dose Era.',
    person_id = 'A foreign key identifier to the Person.',
    drug_concept_id = 'A foreign key identifier to the Drug Concept representing the specific drug ingredient.',
    unit_concept_id = 'A foreign key identifier to the Concept representing the unit of the drug ingredient dosage.',
    dose_value = 'The numeric value of the dosage of the drug ingredient.',
    dose_era_start_date = 'The start date of the Dose Era.',
    dose_era_end_date = 'The end date of the Dose Era.'
  ),
  audits (
