MODEL (
  ...
  column_descriptions (episode_id = 'A foreign key identifier to the EPISODE table.', event_id = 'The primary key of the linked clinical event record (e.g., condition_occurrence_id).', episode_event_field_concept_id = 'A foreign key identifier to the Concept representing the table containing the linked event.')
);
